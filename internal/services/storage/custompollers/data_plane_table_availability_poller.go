...
var _ pollers.PollerType = &DataPlaneTableAvailabilityPoller{}

type DataPlaneTableAvailabilityPoller struct {
	client           shim.StorageTableWrapper
	storageAccountId commonids.StorageAccountId
}

func NewDataPlaneTableAvailabilityPoller(ctx context.Context, client *storageClients.Client, account *storageClients.AccountDetails) (*DataPlaneTableAvailabilityPoller, error) {
	...
	return &DataPlaneTableAvailabilityPoller{
		client:           tableClient,
		storageAccountId: account.StorageAccountId,
	}, nil
}

func (d *DataPlaneTableAvailabilityPoller) Poll(ctx context.Context) (*pollers.PollResult, error) {
